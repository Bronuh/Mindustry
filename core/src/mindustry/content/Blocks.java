...
public class Blocks implements ContentList{
    ...
    public void load(){
        ...
        siliconSmelter = new GenericSmelter("silicon-smelter"){{
            ...
            consumes.items(with(Items.coal, 1, Items.sand, 1));
        ...
        siliconCrucible = new AttributeSmelter("silicon-crucible"){{
            ...
            consumes.items(with(Items.coal, 4, Items.sand, 4, Items.pyratite, 1));
            consumes.power(4f);
        }};
        ...
        plastaniumCompressor = new GenericCrafter("plastanium-compressor"){{
            ...
            consumes.liquid(Liquids.oil, 0.15f);
            consumes.power(1f);
        ...
        phaseWeaver = new GenericCrafter("phase-weaver"){{
            ...
            consumes.items(with(Items.thorium, 4, Items.sand, 6));
            consumes.power(5f);
            itemCapacity = 20;
        }};
        ...
        surgeSmelter = new GenericSmelter("alloy-smelter"){{
            ...
            consumes.power(3f);
            consumes.items(with(Items.copper, 1, Items.lead, 1, Items.titanium, 1, Items.silicon, 1));
        }};
        ...
        cryofluidMixer = new LiquidConverter("cryofluid-mixer"){{
            ...
            outputLiquid = new LiquidStack(Liquids.cryofluid, 0.35f);
            craftTime = 90f;
            size = 2;
            hasPower = true;
            hasItems = true;
        ...
        pyratiteMixer = new GenericSmelter("pyratite-mixer"){{
            ...
            consumes.items(with(Items.coal, 1, Items.lead, 1, Items.sand, 1));
        }};
        ...
        disassembler = new Separator("disassembler"){{
            ...
            consumes.liquid(Liquids.slag, 0.06f);
        }};
        ...
        thoriumWallLarge = new Wall("thorium-wall-large"){{
            ...
            health = 400 * wallHealthMultiplier * 4;
            size = 2;
        }};
        ...
        surgeWall = new Wall("surge-wall"){{
            ...
            health = 460 * wallHealthMultiplier;
        ...
        surgeWallLarge = new Wall("surge-wall-large"){{
            ...
            health = 460 * 4 * wallHealthMultiplier;
            size = 2;
        ...
        doorLarge = new Door("door-large"){{
            ...
            health = 200 * 4 * wallHealthMultiplier;
            size = 2;
        }};
        ...
        scrapWallHuge = new Wall("scrap-wall-huge"){{
            ...
            health = 120 * 9 * wallHealthMultiplier;
            size = 3;
            variants = 3;
        }};
        ...
        scrapWallGigantic = new Wall("scrap-wall-gigantic"){{
            ...
            health = 120 * 16 * wallHealthMultiplier;
            size = 4;
        }};
        ...
        duo = new ItemTurret("duo"){{
            ...
            ammo(
            Items.copper, new BasicBulletType(10f, 18){{
                        width = 7f;
                        height = 9f;
                        lifetime = 60f;
        ...
        scatter = new ItemTurret("scatter"){{
            ...
            ammo(
            Items.scrap, new FlakBulletType(12f, 6){{
                        lifetime = 60f;
                        ammoMultiplier = 5f;
                        shootEffect = Fx.shootSmall;
                        reloadMultiplier = 1f;
            ...
            Items.lead, new FlakBulletType(14f, 9){{
                        lifetime = 60f;
                        ammoMultiplier = 4f;
                        shootEffect = Fx.shootSmall;
                        width = 6f;
        ...
        hail = new ItemTurret("hail"){{
            ...
            ammo(
            Items.graphite, new ArtilleryBulletType(15f, 40, "shell"){{
                        hitEffect = Fx.flakExplosion;
                        knockback = 0.8f;
                        lifetime = 80f;
                        width = height = 11f;
        ...
        swarmer = new ItemTurret("swarmer"){{
            ...
            ammo(
            Items.blastCompound, new MissileBulletType(12.7f, 20){{
                        width = 8f;
                        height = 8f;
                        shrinkY = 0f;
                        drag = -0.01f;
            ...
            Items.pyratite, new MissileBulletType(12.7f, 18){{
            ...
            Items.surgeAlloy, new MissileBulletType(12.7f, 30){{
                        width = 8f;
                        height = 8f;
                        shrinkY = 0f;
                        drag = -0.01f;
        ...
        ripple = new ItemTurret("ripple"){{
            ...
            ammo(
                    Items.graphite, new ArtilleryBulletType(20f, 40, "shell"){
                        {
                            hitEffect = Fx.flakExplosion;
                            knockback = 0.8f;
                            lifetime = 80f;
                    ...
                    Items.blastCompound, new ArtilleryBulletType(20f, 140, "shell"){
                        {
                            hitEffect = Fx.flakExplosion;
                            knockback = 0.8f;
                            lifetime = 80f;
        ...
        meltdown = new LaserTurret("meltdown"){{
            ...
            shootType = new ContinuousLaserBulletType(200){{
                length = 400f;
        ...
        groundFactory = new UnitFactory("ground-factory"){{
            ...
            plans = Seq.with(
                    new UnitPlan(UnitTypes.dagger, 60f * 15, with(Items.lead, 10)),
                    new UnitPlan(UnitTypes.crawler, 60f * 12, with(Items.coal, 20)),
                    new UnitPlan(UnitTypes.nova, 60f * 20, with(Items.silicon, 30, Items.lead, 20))
            );
            size = 3;
            consumes.power(0.6f);
        }};
        ...
        airFactory = new UnitFactory("air-factory"){{
            ...
            plans = Seq.with(
                    new UnitPlan(UnitTypes.flare, 60f * 15, with(Items.lead, 15)),
                    new UnitPlan(UnitTypes.mono, 60f * 15, with(Items.lead, 30))
            );
            size = 3;
            consumes.power(1.2f);
        }};
        ...
        navalFactory = new UnitFactory("naval-factory"){{
            requirements(Category.units, with(Items.copper, 150, Items.lead, 130));
            plans = Seq.with(
                    new UnitPlan(UnitTypes.risso, 60f * 15f, with(Items.lead, 20))
            );
            size = 3;
            consumes.power(1.2f);
            floating = true;
        ...
        additiveReconstructor = new Reconstructor("additive-reconstructor"){{
            requirements(Category.units, with(Items.copper, 200, Items.lead, 120, Items.graphite, 90));

            size = 3;
            consumes.power(3f);
            consumes.items(with(Items.graphite, 40));
        ...
        multiplicativeReconstructor = new Reconstructor("multiplicative-reconstructor"){{
            ...
            size = 5;
            consumes.power(6f);
            consumes.items(with(Items.graphite, 130, Items.titanium, 80));
        ...
        exponentialReconstructor = new Reconstructor("exponential-reconstructor"){{
            ...
            size = 7;
            consumes.power(13f);
            consumes.items(with(Items.graphite, 450, Items.titanium, 350));
        ...
        tetrativeReconstructor = new Reconstructor("tetrative-reconstructor"){{
            ...
            size = 9;
            consumes.power(25f);
            consumes.items(with(Items.graphite, 500, Items.plastanium, 150, Items.surgeAlloy, 150, Items.phaseFabric, 50));
        ...
        illuminator = new LightBlock("illuminator"){{
            requirements(Category.effect, with(Items.graphite, 12, Items.silicon, 8));
            brightness = 1f;
            radius = 220f;
